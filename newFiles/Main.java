...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        while ((linha = br.readLine()) != null) {
            String[] partes = linha.split("\\s+"); // separa por um ou mais espaços
            if (partes.length == 2) {
        ...
        */
        ...
        /* Consultas definidas no próprio código:*/
        ...
        for (String[] consulta : consultas) {
            String resultado = arvore.consultParentesco(consulta[0], consulta[1]);
